...
-- -----------------------------------------------------
-- procedure sp_fornecedores_insert
-- -----------------------------------------------------

DELIMITER $$
USE `syspecdb`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_fornecedores_insert`(
    spid int(4), 
...
-- -----------------------------------------------------
-- procedure sp_fornecedores_update
-- -----------------------------------------------------

DELIMITER $$
USE `syspecdb`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_fornecedores_update`(
